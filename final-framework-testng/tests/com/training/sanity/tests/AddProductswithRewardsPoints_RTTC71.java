// This Test case is to verify whether application allows admin to add multiple product with the rewards point
...
import com.training.generics.ScreenShot;
	...
	public class AddProductswithRewardsPoints_RTTC71{
	   ...
	   @Test(dataProvider="excel-inputs",dataProviderClass=LoginDataProviders.class)
		...
		//	get the value for price discount from the excel sheet.
			AddProductPOM_Retail.SendPricediscount(discount);
		// get the value for rewards point from the excel sheet.	
